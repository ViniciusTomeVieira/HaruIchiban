...
public class ConstruirPadrao extends CriadorDeTabuleiro {
    ...
    public void construirTabuleiro(Peca[][] tabuleiro) {
        ...
        tabuleiro[0][2] = new NenufarClaro(nenufarBase);
        ...
        tabuleiro[1][3] = new NenufarEscuro(nenufarBase); // Aleatorio?
        ...
        tabuleiro[2][4] = new NenufarClaro(nenufarBase);

        tabuleiro[3][0] = new Agua();
        tabuleiro[3][1] = new NenufarClaro(nenufarBase);
        tabuleiro[3][2] = new NenufarClaro(nenufarBase);
